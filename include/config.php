...
// Site name
if (!defined('SITE_NAME')) define('SITE_NAME', 'Harambee Student Living');  // Added missing SITE_NAME constant
...
if (!defined('MAIL_FROM_NAME')) define('MAIL_FROM_NAME', getenv('MAIL_FROM_NAME') ?: SITE_NAME);  // Set to SITE_NAME
